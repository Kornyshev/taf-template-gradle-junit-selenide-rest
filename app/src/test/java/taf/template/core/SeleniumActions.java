...
public class SeleniumActions {
    ...
    public static boolean waitUntilCondition(SelenideElement element, WebElementCondition condition, long time) {
        try {
    ...
    private static Callable<Boolean> checkForCondition(SelenideElement element, WebElementCondition condition) {
